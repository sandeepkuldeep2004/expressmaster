...
const {getCustomers} = require("../../services/customer.js");


var leftnavigationlinkactive = "manageCustomer";
...
router.get("/viewAll", ensureAuth, async (req, res) => {
  try {
    const userCustomerList = await getCustomers();
    res.render("customer/list", {
      userCustomerList,
      csrfToken: req.csrfToken(),
    leftsubnavigationlinkactive:"customer",
    leftnavigationlinkactive:leftnavigationlinkactive,
    });
  } catch (err) {
    console.error(err);
